        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" name="formulario"   role="form" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label for="email-confirm" class="col-md-4 control-label">Repetir e-mail</label>
